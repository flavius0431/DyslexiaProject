    ...
    if (content1 === content2) {
        ...
        if (foundPairs == 12) {
            setTimeout(() => {
                ...
                setTimeout(() => {
                    var congratulationSound = new Audio('../letterSounds/congratulations-letters-images.mp3');
...
function shuffleCards() {
    ...
    let shuffledLetters = shuffleArray(letters).slice(0, 12); // Select 8 random letters
    ...
    arr[16] = shuffledLetters2[8];
    arr[17] = shuffledLetters[8];
    arr[18] = shuffledLetters2[9];
    arr[19] = shuffledLetters[9];
    arr[20] = shuffledLetters2[10];
    arr[21] = shuffledLetters[10];
    arr[22] = shuffledLetters2[11];
    arr[23] = shuffledLetters[11];
